...
#"r "mode
with open("File_handling_read.txt","r") as file1:  # "with" helps to open the file and close it safely.
...
with open("File_handling_write.txt","w") as file1: # a new file will be created after the execution
    file1.write("this is the new  text after using Write mode")
    print(file1)
...
with open("File_handling_write.txt","a") as file4:
    file4.write("\n this is new text form Append mode")